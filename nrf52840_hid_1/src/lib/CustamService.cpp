...
BLECustam::BLECustam(void) :
  ...
  _characteristic_input("0000ff02-0000-1000-8000-00805f9b34fb", BLERead | BLENotify, 32, false), // UUID, パーミッション, データサイズ, データサイズ固定かどうか
  _characteristic_output("0000ff03-0000-1000-8000-00805f9b34fb", BLEWrite, 32, false) // UUID, パーミッション, データサイズ, データサイズ固定かどうか
{
